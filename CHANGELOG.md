...
-   Updated demo app to minimal APIs style for .NET 6 with the latest [Serilog example](https://blog.datalust.co/using-serilog-in-net-6/).
-   Updated nuget references to latest versions.
-   Ensure `LogName` stays under length limit.
